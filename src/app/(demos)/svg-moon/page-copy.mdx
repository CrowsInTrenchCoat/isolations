...
My design-brain informed me that I needed to start with a circle composed of points placed at the top, right, bottom, and left-most ends of the circumference of the circle. With a structure like this I should be able to adjust the coordinates of the left or right points to create the illusion of a shadowed moon.
